 ...
 * 
 * author: Michael Kolling version: 1.0 date: July 1999 test2 This class holds
 * information about a command that was issued by the user. A command currently
 * consists of two strings: a command word and a second word (for example, if
 * the command was "take map", then the two strings obviously are "take" and
 * "map").
 * 
...
class Command {
	...
	/**
	 * Return the third word of this command. Returns null if there was no second
	 * word.
	 */
